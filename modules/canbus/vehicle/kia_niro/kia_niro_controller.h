...
/**
 * @file Kia_niroController.h
 * @brief The class of Kia_niroController
 */
...
/**
 * @namespace apollo::canbus::kia_niro
 * @brief apollo::canbus::kia_niro
 */
namespace apollo {
namespace canbus {
namespace kia_niro {
...
/**
 * @class Kia_niroController
 *
 * @brief this class implements the vehicle controller for Kia_niro vehicle.
 */
class Kia_niroController final : public VehicleController {
 public:
  /**
   * @brief initialize the Kia_niro vehicle controller.
  ...
  FRIEND_TEST(Kia_niroControllerTest, SetDrivingMode);
  FRIEND_TEST(Kia_niroControllerTest, Status);
  FRIEND_TEST(Kia_niroControllerTest, UpdateDrivingMode);
 ...
 private:
  ...
  bool CheckSafetyError(const canbus::ChassisDetail &chassis); // Omar check this
 ...
 private:
  ...
  Gear66 *gear_66_ = nullptr;              //Omar check this
  Turnsignal68 *turnsignal_68_ = nullptr;  //Omar check this
